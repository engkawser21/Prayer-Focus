...
export const translations: Record<'en' | 'bn', TranslationDictionary> = {
  en: {
    ...
    liveBlockerDesc: "Don't want to wait until the scheduled hour? Test the full implementation of Prayer Mode immediately by starting a simulated 1-minute lock.",
    testOverlaySection: "Simulate 1-Minute Block Event:",
  ...
  bn: {
    ...
    liveBlockerDesc: "পরবর্তী নামাজের ওয়াক্ত আসার আগে অ্যাপ লক দেখতে কেমন দেখাবে তা পরীক্ষা করতে চান? ১ মিনিটের একটি ডেমো লক সচল করে দেখুন।",
    testOverlaySection: "১ মিনিটের লক পরীক্ষা সচল করুন:",
